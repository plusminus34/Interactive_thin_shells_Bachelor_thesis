...
private:
	...
	template<class T>
	static T computeEnergy(const Vector3T<T> &eePosjp1, const Vector3T<T> &eePosj, double dt, const Vector3T<T> &wheelRadiusV, const T &wheelRadius, const Vector3T<T> &wheelAxis, const T &alphaj, const T &alphajp1, const T &speed, double c, double weight) {
