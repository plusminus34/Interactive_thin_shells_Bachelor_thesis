...
namespace igl
{
  namespace matlab
  {
	...
	IGL_INLINE void mlsetmatrix(Engine** mlengine, std::string name, const std::vector<int> & M);
	// Send a matrix to MATLAB
    IGL_INLINE void mlsetcellarray(Engine** mlengine, std::string name, const std::vector<std::vector<int>>);
