...
public:
	...
	*/
	CMAFunctionMinimizer(int maxIterations = 5000, int populationSize = 16, double initialStdDev = 0.05, double solveFunctionValue = 0.001, double solveHistToleranceValue = 1e-13);
	virtual ~CMAFunctionMinimizer();
	...
	*/
	...
	virtual bool minimize(ObjectiveFunction *function, dVector &p, const dVector& initialStdDev, double stdDevModifier, double &functionValue);
