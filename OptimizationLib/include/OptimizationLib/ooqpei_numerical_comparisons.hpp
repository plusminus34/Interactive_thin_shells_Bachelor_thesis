...
#ifndef OOQPEI_NUMERICALCOMPARISON_HPP_
#define OOQPEI_NUMERICALCOMPARISON_HPP_
...
{
  OOQPEI_ASSERT_GT_DBG(std::invalid_argument, epsilon, 0.0, "This method is only valid for an epsilon greater than 0.");
...
#endif /* OOQPEI_NUMERICALCOMPARISON_HPP_ */
