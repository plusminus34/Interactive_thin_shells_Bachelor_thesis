...
#include <OptimizationLib/ooqpei_numerical_comparisons.hpp>
	...
	const dVector& l, const dVector& u)
{
  ...
  cout << "Q (triangular) << " << endl << MatrixNxM(Q) << endl;
  cout << "c << " << c.transpose() << endl;
  cout << "A << " << endl << MatrixNxM(A) << endl;
  cout << "b << " << b.transpose() << endl;
  cout << "C << " << endl << MatrixNxM(C) << endl;
